...
class DeviceManager {
    ...
    public function SetFolderSyncStatus($folderid, $statusflag) {
        ...
        if (isset($currentStatus[ASDevice::FOLDERSYNCSTATUS]) || $statusflag == self::FLD_SYNC_INITIALIZED) {
            ...
            if (isset($statusflag) && isset($currentStatus[ASDevice::FOLDERSYNCSTATUS]) && $statusflag !== $currentStatus[ASDevice::FOLDERSYNCSTATUS] && $statusflag != self::FLD_SYNC_COMPLETED) {
